...
SWFUpload.prototype.getFlashHTML1 = function (flashVersion) {
...
SWFUpload.prototype.getFlashHTML2 = function (flashVersion) {
	// Flash Satay object syntax: http://www.alistapart.com/articles/flashsatay
	return ['<object ',
				'id="', this.movieName,'" ',
				'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ',
				'codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" ',
				'data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url),'" ',
				'class="swfupload" >',
				'<param name="wmode" value="', this.settings.button_window_mode, '" />',
				'<param name="movie" value="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" />',
				'<param name="quality" value="high" />',
				'<param name="allowScriptAccess" value="always" />',
				'<param name="flashvars" value="' + this.getFlashVars() + '" />',
				'<embed width="',this.settings.button_width,'" height="',this.settings.button_height,'" ',
				...
				'src="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" ',
				'type="application/x-shockwave-flash"  pluginspage="http://www.macromedia.com/go/getflashplayer" >',
				'</object>'].join("");
};
SWFUpload.prototype.getFlashHTML = function (flashVersion) {//兼容性写法 暂不写百度处理方式
	// Flash Satay object syntax: http://www.alistapart.com/articles/flashsatay
	return ['<object ',
				'id="', this.movieName,'" ',
				//'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ',
				...
				'type="application/x-shockwave-flash"  pluginspage="http://www.macromedia.com/go/getflashplayer" ',
				'data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url),'" ',
				'width="',this.settings.button_width,'" height="',this.settings.button_height,'" ',
				'class="swfupload" >',
				'<param name="wmode" value="', this.settings.button_window_mode, '" />',
				'<param name="movie" value="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" />',
				'<param name="quality" value="high" />',
